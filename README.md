...
| Docs | pip package | conda package | Paper | Colab |
|:-:|:-:|:-:|:-:|:-:|
...
## Getting Started
To run an example fit, get the datasets by cloning this repo:
```
git clone https://github.com/hftsoi/symbolfit.git
```
Then in a Python env (or simply do ```python fit_example.py```):
```
