...
To define the function space being searched by PySR, one can check out the PySR documentation [here](https://astroautomata.com/PySR/#detailed-example) for full descriptions of all options.
